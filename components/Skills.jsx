...
function Skills() {
  ...
  return (
    <div name="skills" className=" flex flex-col justify-center items-center">
      <div className="w-11/12 h-screen ">
        ...
        <div className="flex w-full flex-col-reverse md:flex-row gap-2">
          <div className="flex w-6/12 flex-wrap gap-2 justify-center items-center">
            <SkillsCustom onButtonClick={handleButtonClick} />
          </div>
          <div className="flex justify-center items-top w-6/12  p-2">
